export default {
  ...
  'menu.form': 'Biểu mẫu',
  'menu.form.basicform': 'Biểu mẫu cơ bản',
  ...
  'menu.list': 'List',
  'menu.list.searchtable': 'Tìm trong bảng biểu',
  ...
  'common.please_enter': "Vui lòng nhập",
  'common.rule_name': "Tên quy định",
};
